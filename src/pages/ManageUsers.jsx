...
const ManageUsers = () => {
    ...
    const {
        ...
        queryKey: ["users"],
        queryFn: () =>
            getAllHandler(`https://demo-mern-job-portal-server-kappa.vercel.app/api/v1/users`),
    });
    ...
    const UpdateUserRole = async (id, role) => {
        ...
        try {
            const response = await axios.patch(
                `https://demo-mern-job-portal-server-kappa.vercel.app/api/v1/admin/update-role`,
                updateUser,
