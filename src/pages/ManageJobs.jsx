...
const ManageJobs = () => {
    const {
        ...
        queryFn: () =>
            getAllHandler(
                `https://demo-mern-job-portal-server-kappa.vercel.app/api/v1/jobs/my-jobs`
            ),
    });
    ...
    const deleteJobHandler = async (id) => {
        try {
            const response = await axios.delete(
                `https://demo-mern-job-portal-server-kappa.vercel.app/api/v1/jobs/${id}`,
            ...
            // setJobs(updateJobs);
            // handleJobFetch(
            //     `https://demo-mern-job-portal-server-kappa.vercel.app/api/v1/jobs?page=1`
            // );
            refetch();
            Swal.fire({
                title: "Deleted!",
